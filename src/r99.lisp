...
order by answers.num")))
    (page
      ...
      (:h2 "WARN")
      (:p :class "warn"
          "自力で回答考え、動作確認、字下げそろえて送信のルールなのに、"
          "どこからからガセネタ拾ってコピー送信するバカがたくさん。"
          "どこまでバカなんだろうね。点数稼ぎにはならないよ。心証悪くするだけ。"
          "期末テストももちろんだが、R99 も動作確認せずの回答はマイナスだから。")
      (:p :class "warn"
          "採点始まる前に R99 だけでも直しとき。"
          "怪しいとこ確認後に採点する。"
          "手間のかかるバカ達だ。減点は致命傷か？ちゃんと勉強すればいいのに。")
      (:p :class "warn"
          "って書いたら、数分の間に俺の回答でインチキ回答上書きするやつ続出だ。"
          "そんなん、勉強した方が早いぞ、ボケちゃん、"
          "書き換えの記録が残るんだから。myid から変換した学生番号、晒してやろうか？")
      (:p :class "warn"
          "クラスのグループ LINE で拡散しよう。")
      (:hr)
      (:h3 "連絡事項")
      (:ul
